 ...
 *
 * Locks down the internal dev standards "Bulk-Write-Path Standard" Punkt 2:
...
class BulkCommandHashGuardTest extends TestCase
{
    ...
    public function test_bulk_command_calls_verifyHashes(string $relativePath): void
    {
        ...
        $this->assertStringContainsString(
            ...
            "Bulk-Write-Path Standard (the internal dev standards) — silent overwrite of concurrent ".
