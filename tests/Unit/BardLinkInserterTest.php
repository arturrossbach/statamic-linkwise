...
class BardLinkInserterTest extends TestCase
{
    ...
    // (Bug 19's anchor-offset narrowing tests removed in the position-passing
    // sweep — see commit history. RelinkService no longer uses the find-first
    // walker for re-link; AutoLink/ApplyRule callers don't pass offset.
    // Position-based regression coverage lives in tinker smoke + browser
    // retests for now; a RelinkService end-to-end test fixture is a follow-up.)
}
