...
class AutoLinkController extends CpController
{
    ...
    /**
     * Sync Apply lives in {@see \Arturrossbach\Linkwise\Http\Controllers\AutoLink\AutoLinkApplySyncController}
     * since REV-AL-01 (Sprint 4 Part 4). Route `linkwise.autolink.apply` is
     * bound there. Async apply endpoints (below) remain here.
     */
