...
class DashboardController extends CpController
{
    ...
    // Activity-Detail-API (activityDetail + markActivityReverted + deepLinkSearchFor helper)
    // extracted to {@see \Arturrossbach\Linkwise\Http\Controllers\Dashboard\ActivityController}
    // during REV-DR-01 Phase B PR 3.
