...
Flip the master switch in Linkwise's settings at `/cp/addons/linkwise/settings`,
under **Auto-Linking → Auto-Apply Rules on Entry Save**, or in the
[config file](/usage/configuration):
